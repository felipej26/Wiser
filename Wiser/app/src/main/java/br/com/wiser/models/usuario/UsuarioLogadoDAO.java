 ...
 */
public class UsuarioLogadoDAO extends SQLiteOpenHelper {
    ...
    public void logarUsuario() {
        ...
        /*
        String sql =
                "UPDATE " + TABELA + " SET logado = 0 WHERE logado = 1;" +
                "INSERT INTO " + TABELA + " (id, data, logado) VALUES (" +
                        Sistema.getUsuario().getUserID() + ", " +
                        "'" + UtilsDate.formatDate(new Date(), YYYYMMDD_HHMMSS) + "', " +
                        "1" +
                ");";
